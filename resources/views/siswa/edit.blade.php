...
<head>
    <meta charset="UTF-8">
    <title>Edit Siswa — {{ $kelas->nama_kelas }}</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="glass-card">
            <form method="POST" action="{{ route('siswa.update', [$kelas->id, $siswa->id]) }}">
                @csrf
                @method('PUT')
                ...
                <div class="field">
                    ...
                    <input type="text" id="nomor_absen" name="nomor_absen" value="{{ old('nomor_absen', $siswa->nomor_absen) }}" required>
                </div>

                <div class="field">
                    <label for="password">Password Baru <span class="field-hint">(Kosongkan jika tidak ingin mengubah)</span></label>
                    <input type="text" id="password" name="password" placeholder="Password baru...">
                </div>

                <button type="submit" class="btn-submit">Update Data Siswa</button>
            </form>
        </div>
    </div>
</body>
